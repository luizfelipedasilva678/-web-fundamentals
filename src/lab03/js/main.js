...
(function() {
    ...
    function makeMovieCards() {
        ...
        const cards = moviesData().map((movieValues) => {
                    ...
                    <div class="card-infos">
                        ...
                        <div class="titulos-semelhantes">
                            ...
                            <ul class="card-titulos-semelhantes">
                                ${ movieValues.titulosSemelhantes.map((titulos) => {return `<li> ${ titulos } </li>`} ).join('') }
                            </ul>
                        </div>
                        <div class="card-classificacao">
                            <p> Classificação: ${movieValues.classificacao} anos </p>
                        </div>
